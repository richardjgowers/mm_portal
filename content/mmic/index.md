...
The MMIC package is written in python. For more info about the API and component design, see the online <a href="https://github.com/MolSSI/MMIC">documentation</a>.

# Data validation

Python does not inherently enforce typing of functions or variables at
...
Each component has two schema, an Input Schema and an Output Schema.
...
{{< tabsCode
    file1="/content/mmic/codes/run.md" title1="run" language1="python" icon1="python"
    file2="/content/mmic/codes/output.md" title2="output" language2="shell" icon2="shell"
>}}
